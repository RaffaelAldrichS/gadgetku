...
<div class="container my-5">
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5">
        <div class="col-10 mx-auto col-sm-8 col-lg-6">
            <img src="img/samsung_s21.png" class="d-block mx-lg-auto img-fluid" alt="samsung_s21" />
        </div>
        <div class="col-lg-6">
            ...
            <div class="lc-block mb-3">
                <div editable="rich">
                    <p class="lead text-hitam fw-medium">
            ...
            <div class="lc-block d-grid gap-1 d-md-flex justify-content-md-start">
                <a class="btn bg-hijau px-4 me-md-2 rounded-5 text-putih" href="index.php?target=products" role="button">Product</a>
                <a class="btn bg-putih px-4 rounded-5 text-hitam" href="index.php?target=support" role="button">Support</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="bg-putih-product rounded-5 d-flex justify-content-center flex-column py-3">
                    <img src="./img/samsung s24.png" alt="samsung s24" width="170" height="170" class="mx-auto" />
                    <p class="text-hitam fw-semibold mx-auto fs-5">Smartphone</p>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="bg-putih-product rounded-5 d-flex justify-content-center flex-column py-3">
                    <img src="./img/laptops.png" alt="samsung s24" height="170" class="mx-auto" />
                    <p class="text-hitam fw-semibold mx-auto fs-5">Laptops</p>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="bg-putih-product rounded-5 d-flex justify-content-center flex-column py-3">
                    <img src="./img/desktop.png" alt="samsung s24" width="170" height="170" class="mx-auto" />
                    <p class="text-hitam fw-semibold mx-auto fs-5">Desktops</p>
                </div>
            </div>
        </div>

        <div class="lc-block d-grid gap-1 d-md-flex justify-content-md-start">
            <a class="btn btn-outline-dark px-4 rounded-5 mx-auto" href="index.php?target=products" role="button">See More
    ...
    <div class="row">
        <?php for ($i = 1; $i <= 6; $i++) : ?>
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="lc-block bg-white rounded-5 shadow"><img src="./img/infinix note 40.png" loading="lazy" width="100%">
                    <div class="lc-block p-4">
                        <div editable="rich">
                            ...
                            <a href="index.php?target=productDetail" class="link-offset-2 link-underline link-underline-opacity-0">Detail Product</a>
                        </div>
                    </div>
                </div>
            </div>
