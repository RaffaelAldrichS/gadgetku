        ...
        <div class="container overflow-hidden">
            <div class="row gy-4 gy-lg-0 justify-content-xl-between">
                <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                    <div class="widget">
                        <a href="#!">
                            <img src="./img/GadgetKu.png" alt="GadgetKu Logo" width="145">
                        </a>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                    <div class="widget">
                        ...
                        <address class="mb-4">Jl. Slamet Riyadi, Surakarta, Jawa Tengah, Indonesia</address>
                        <p class="mb-1">
                            <a class="link-secondary text-decoration-none" href="tel:+15057922430">(+62) 812-xxxx-xxxx</a>
                        </p>
                        <p class="mb-0">
                            <a class="link-secondary text-decoration-none" href="mailto:gadgetku.tech@gmail.com">gadgetku.tech@gmail.com</a>
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3 col-xl-2">
            ...
            <div class="row gy-4 gy-md-0">
                <div class="col-xs-12 col-md-7 order-1 order-md-0">
                    <div class="copyright text-center text-md-start">
                        &copy; GadgetKu 2024. All Rights Reserved.
                    </div>
                </div>
